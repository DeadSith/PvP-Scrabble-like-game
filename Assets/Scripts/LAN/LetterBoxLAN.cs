...
public class LetterBoxLAN : NetworkBehaviour
{
    ...
    [SyncVar(hook = "OnEndGame")] public int Winner;

    [SyncVar]
    public int BonusScore = 0;

    [SyncVar(hook = "OnShowEnd")] public bool End = false;
    ...
    {
        Debug.LogError("Entered comamnd");
        Winner = winner;
    }
